...
1. `cfr_omit`: **skip existence is now AUTHOR-CONFIRMED by Martin Schmid (2026-08-16)**. Exact `500` remains RELEASED-CODE-ANCHORED, not directly author-confirmed for private HUNL. Historical note: this item was previously DOWNGRADED to HYPOTHESIS because offline
