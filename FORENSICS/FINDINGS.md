...
| skip/omit (offline) | PARTIAL AUTHOR-CONFIRMED | Martin Schmid (email 2026-08-16) recalls skip iterations were always used; exact count not stated. `500` remains RELEASED-CODE-ANCHORED to DeepStack-Leduc. |
